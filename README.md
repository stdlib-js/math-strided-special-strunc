...
```javascript
strunc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-strunc@v0.2.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-strided-special-strunc/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-strided-special-strunc/actions/workflows/test.yml?query=branch:v0.2.0
