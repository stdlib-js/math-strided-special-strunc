...
```javascript
strunc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-strunc@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-strunc@umd/bundle.js"></script>
```
